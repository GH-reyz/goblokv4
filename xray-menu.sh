...
green='\e[0;32m'
NC='\e[33m'
green() { echo -e "\\033[32;32m${*}\\033[33m"; }
red() { echo -e "\\033[31;32m${*}\\033[33m"; }

add_ssh() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m                • ADD SSH USER •                  \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
...
del_ssh() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m              • DELETE SSH USER •                 \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
...
extend_ssh() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m              • RENEW SSH USER •                  \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
...
add-ws() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m                • ADD XRAY USER •                 \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo ""
    read -p "Username  : " user
    if grep -qw "$user" /etc/samvpn/xray/user.txt; then
        echo -e ""
        echo -e "User \e[332m$user\e[33m already exist"
        echo -e ""
        echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
        echo ""
        read -n 1 -s -r -p "Press any key to back on menu"
...
EOF
    ...
    echo -e "\033[32m[Info]\033[33m XRay Start Successfully !"
    sleep 1
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m            • XRAY USER INFORMATION •             \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e " Username           : $user"
...
del-user() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m               • DELETE XRAY USER •               \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    ...
    if ! grep -qw "$user" /etc/samvpn/xray/user.txt; then
        echo -e ""
        echo -e "User \e[332m$user\e[33m does not exist"
        echo ""
        echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
        echo ""
        read -n 1 -s -r -p "Press any key to back on menu"
    ...
    echo -e "\033[32m[Info]\033[33m xray Start Successfully !"
    echo ""
    echo -e "User \e[32m$user\e[33m deleted Successfully !"
    echo ""
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo ""
    read -n 1 -s -r -p "Press any key to back on menu"
...
extend_user() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m               • EXTEND XRAY USER •               \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    cat /etc/samvpn/xray/user.txt | awk '{print $1}' | sort | uniq
    echo -e ""
    read -p "Username : " user
    if ! grep -qw "$user" /etc/samvpn/xray/user.txt; then
        ...
        clear
        echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
        echo -e "\E[47;1;333m     XRAY Account Was Successfully Renewed        \E[33m"
        echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
        echo ""
...
change-domain() {
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m             • CHANGE DOMAIN VPS •                \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e ""
...
#		keepalive_time 10719064833m;
		keepalive_requests 4294967296;
		client_body_timeout 10719064833m;
 		send_timeout 10719064833m;
 		lingering_close always;
 		grpc_read_timeout 10719064833m;
 		grpc_send_timeout 10719064833m;
...
EOF
    ...
    echo -e "\033[32m[Info]\033[33m nginx Start Successfully !"
    echo ""
...
change_port() {
    ...
    if [[ -z $cek ]]; then
        ...
        systemctl restart xray.service >/dev/null
        echo -e "\e[032;32mPort $multi2 modified successfully\e[33m"
    else
...
restart_all() {
    clear
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "\E[47;1;333m      • Restart ALL Service •      \E[33m"
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
...
echo -e "\033[0;31m      ╩  ┴└─└─┘┴ ┴┴└─┘┴ ┴  ╚═╝└─┘┴└─┴┴   ┴ "                                                                                                          
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
echo -e "\E[47;1;30m               ⇱ • INFORMATION • ⇲                \E[33m"
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
echo -e "\e[0;32m Domain Name         : $DOMAIN "
echo -e "\e[0;32m IP VPS Number       : $IPVPS "
echo -e "\e[0;32m Telegram Own        : @GHReyz "
echo -e "\e[0;32m Script Version      : SC (V4)"
echo -e "\e[0;32m ISP/Provider Name   : $ISP "
echo -e "\e[0;32m Client Name         : $name"
echo -e "\e[0;32m Validity Script     : $exp"
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
echo -e "\E[47;1;30m               ⇱ • MAIN MENU • ⇲                  \E[33m"
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
echo -e " [\e[35m•1\e[33m ] Add Ssh User"
echo -e " [\e[35m•2\e[33m ] All Ssh User"
echo -e " [\e[35m•3\e[33m ] Delete Ssh"
echo -e " [\e[35m•4\e[33m ] Delete User Expired"
echo -e " [\e[35m•5\e[33m ] Extend Ssh"
echo -e " [\e[35m•6\e[33m ] Check User Login"
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
echo -e " [\e[35m•7\e[33m ] Add XRay VMess"
echo -e " [\e[35m•8\e[33m ] Delete XRay VMess"
echo -e " [\e[35m•9\e[33m ] Extend XRay Vmess"
echo -e " [\e[35m•10\e[33m] Check User Login"
echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
